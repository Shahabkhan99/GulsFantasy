...
let reci = {
  ...
  "shepherds-pie": {
    ...
    ing: [
      ...
      "375 grams (approximately 15 strips) smoked beef bacon",
  ...
  "burger-patties": {
    name: "Keto burger patties with creamy tomato sauce and fried cabbage",
    url: "https://www.dietdoctor.com/recipes/keto-burger-patties-tomato-sauce-cabbage",
    image: "https://i.imgur.com/MkQpbsS.png",
    ing: [
      "<p class='org-text'>Burger patties</p>",
      "1½ lbs ground beef",
      "1 egg",
    ...
    dir: [
      "<p class='org-text'>Burger patties and gravy</p>",
      "Add all ingredients for the burgers to a large bowl. Blend it using a wooden spoon or your clean hands. Don't over mix since that can make your patties tough. Use wet hands to form eight oblong patties.",
...
try {
  ...
  // );
  $(".rando").attr("href", `other/keto/KetoFood/recipe.html?r_id=${item}`);
